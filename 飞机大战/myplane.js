...
var enemttimer=setInterval(function(){
	for(var i=0;i<ranNum(1,5);i++){
		var num=ranNum(1,20);
		if(num<15){//w,h,x,y,imgurl,boomurl,speed,blood,score)

			new Enemy({w:34,h:24,x:ranNum(0,myplanebox.offsetWidth-34),y:-24,imgurl:'img/smallplane.png',boomurl:'img/smallplaneboom.gif',speed:ranNum(1,3),blood:1,score:1});
		}else if(num>=15 && num<20){
			new Enemy({w:46,h:60,x:ranNum(0,myplanebox.offsetWidth-46),y:-60,imgurl:'img/midplane.png',boomurl:'img/midplaneboom.gif',speed:ranNum(1,2),blood:3,score:3});
		}else if(num==20){
			new Enemy({w:110,h:164,x:ranNum(0,myplanebox.offsetWidth-110),y:-164,imgurl:'img/bigplane.png',boomurl:'img/bigplaneboom.gif',speed:ranNum(1,1),blood:10,score:10});
		}
	}
},1000);
